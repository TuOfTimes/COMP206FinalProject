...
int main(void) { //page when player loses
  ...
  printf("I'm sorry, you have lost! Please try again.\n");

  printf("</textarea><form action=\"dead.cgi\" method=\"post\"><input type=\"text\" name=\"command\" style=\"width: 523px; align: center\"><input type=\"hidden\" name=\"inventory\" value=\"0,0\"><input type=\"submit\" value=\"Submit\"></form></p></br></br><center></body></html>");
